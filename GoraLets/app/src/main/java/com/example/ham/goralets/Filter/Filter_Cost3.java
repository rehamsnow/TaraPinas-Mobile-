...
public class Filter_Cost3 extends AppCompatActivity {

    private static final String URL_DEALS = "http://magreport.myapc.edu.ph/TaraPinas/Api_sortByCost3%20(1).php";
    List<DealsGetSet> C3List;
    RecyclerView recyclerView;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_filter__cost3);
        ...
        bottomNavigationView.setOnNavigationItemSelectedListener(new BottomNavigationView.OnNavigationItemSelectedListener() {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                if(item.getItemId() == R.id.homeItem){
                    Intent i = new Intent(Filter_Cost3.this, MainActivity.class);
                    //i.putExtra("Email", str);
                    startActivity(i);
                }
                else if(item.getItemId() == R.id.bookingItem){
                    Intent i = new Intent(Filter_Cost3.this, Bookings.class);
                    startActivity(i);
                }
                else if (item.getItemId() == R.id.messagesItem){
                    Intent i = new Intent(Filter_Cost3.this, Messages.class);
                    startActivity(i);
                }
                else if(item.getItemId() == R.id.accountItem){
                    Intent i = new Intent(Filter_Cost3.this, Account2.class);
                    startActivity(i);
                }
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, URL_DEALS,
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        Toast.makeText(Filter_Cost3.this, error.getMessage(), Toast.LENGTH_SHORT).show();
                    }
                });
